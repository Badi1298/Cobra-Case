...
export default function OrderReceivedEmail({ shippingAddress, orderId, orderDate }: OrderReceivedEmailProps) {
	const baseUrl = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://cobra-case-phi.vercel.app';
