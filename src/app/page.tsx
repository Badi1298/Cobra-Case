						...
						<div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
							...
							<div className="text-lg leading-8">
								<p>
									...
									<span className="text-green-600">the image is super clear</span>, on the case I had before, the image started fading into a
									yellow-ish color aftea a couple of weeks. Love it.&quot;
								</p>
							</div>
